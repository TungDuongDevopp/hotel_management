    ...
    <div class="row">
      ...
      <div class="col-12 my-5 px-4">
        <h2 class="fw-bold h-font" style="color:var(--primary-dark);">
          <i class="bi bi-person-gear me-2" style="color:var(--gold);"></i>
          Quản lý tài khoản cá nhân
        </h2>
        <div style="font-size: 14px;">
          <a href="index.php" class="text-secondary text-decoration-none">Trang chủ</a>
          <span class="text-secondary mx-1"><i class="bi bi-chevron-right" style="font-size:.7rem;"></i></span>
          <span class="text-muted">Hồ sơ cá nhân</span>
        </div>
      </div>

      <!-- UC12: Xem thông tin + UC13: Đổi thông tin -->
      <div class="col-12 mb-5 px-4">
        <div class="bg-white p-3 p-md-4 rounded shadow-sm profile-section">
          <form id="info-form">
            <h5 class="mb-3 fw-bold"><i class="bi bi-person-vcard"></i> Thông tin cá nhân</h5>
            <div class="row">
      ...
      <div class="col-md-4 mb-5 px-4">
        <div class="bg-white p-3 p-md-4 rounded shadow-sm profile-section">
          <form id="profile-form">
            <h5 class="mb-3 fw-bold"><i class="bi bi-camera"></i> Ảnh đại diện</h5>
            <div class="text-center mb-3">
              <img src="<?php echo USERS_IMG_PATH . $u_fetch['profile'] ?>" class="rounded-circle img-fluid profile-avatar" style="width:120px;height:120px;object-fit:cover;">
            </div>
      ...
      <div class="col-md-8 mb-5 px-4">
        <div class="bg-white p-3 p-md-4 rounded shadow-sm profile-section">
          <form id="pass-form">
            <h5 class="mb-3 fw-bold"><i class="bi bi-shield-lock"></i> Đổi mật khẩu</h5>
            <div class="row">
              <div class="col-md-12 mb-3">
                <label class="form-label">Mật khẩu hiện tại</label>
                <input name="old_pass" type="password" class="form-control shadow-none" required placeholder="Nhập mật khẩu hiện tại">
              </div>
              <div class="col-md-6 mb-3">
                <label class="form-label">Mật khẩu mới</label>
                <input name="new_pass" type="password" class="form-control shadow-none" required placeholder="Tối thiểu 8 ký tự, có chữ hoa, chữ thường, số và ký tự đặc biệt">
              </div>
              <div class="col-md-6 mb-4">
                <label class="form-label">Xác nhận mật khẩu mới</label>
                <input name="confirm_pass" type="password" class="form-control shadow-none" required placeholder="Nhập lại mật khẩu mới">
              </div>
            </div>
            <button type="submit" class="btn text-white custom-bg shadow-none">
  ...
  <script>
    ...
    pass_form.addEventListener('submit', function(e) {
      ...
      xhr.onload = function() {
        ...
        } else if (this.responseText == 'weak_password') {
          alert('error', "Mật khẩu không đảm bảo tính bảo mật! Vui lòng dùng ít nhất 8 ký tự, chữ hoa, chữ thường, số và ký tự đặc biệt.");
