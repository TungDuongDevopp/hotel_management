<?php
  ...
  if(isset($_POST['add_user'])){
    ...
    } else if(!validate_phone($frm_data['phonenum'])){
      alert('error','Số điện thoại không hợp lệ. Vui lòng nhập 10 hoặc 11 chữ số bắt đầu bằng 0.');
    } else {
      // Check duplicate
  ...
  if(isset($_POST['edit_user'])){
    ...
    } else if(!empty($frm_data['phonenum']) && !validate_phone($frm_data['phonenum'])){
      alert('error','Số điện thoại không hợp lệ. Vui lòng nhập 10 hoặc 11 chữ số bắt đầu bằng 0.');
    } else {
          ...
          <div class="modal-body">
            <div class="row">
              ...
              <div class="col-md-6 mb-3">
                ...
                <input name="phonenum" type="tel" inputmode="numeric" pattern="0[0-9]{9,10}" maxlength="11" title="Số điện thoại bắt đầu bằng 0 và gồm 10 hoặc 11 chữ số" class="form-control shadow-none" required>
              </div>
              <div class="col-md-6 mb-3">
        ...
        <form method="POST">
          ...
          <div class="modal-body">
            ...
            <div class="row">
              ...
              <div class="col-md-6 mb-3">
                <label class="form-label">Số điện thoại</label>
                <input name="phonenum" id="edit_phonenum" type="tel" inputmode="numeric" pattern="0[0-9]{9,10}" maxlength="11" title="Số điện thoại bắt đầu bằng 0 và gồm 10 hoặc 11 chữ số" class="form-control shadow-none">
              </div>
              <div class="col-md-6 mb-3">
