...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th4 11, 2026 lúc 04:09 PM
...
(23, 23, 'Phòng Cơ Bản 3', 1200000, 6000000, NULL, 'Đặng văn tùng dương', '0345976153', 'Gia lộc việt hùng đông anh hà nội');
...
(22, 7, 4, '2024-12-29', '2024-12-31', 1, NULL, 'booked', 'ORD_72382450', NULL, NULL, 'TXN_SUCCESS', NULL, NULL, '2024-12-01 11:32:34'),
(23, 12, 3, '2026-04-18', '2026-04-23', 1, NULL, 'booked', 'ORD_121053599', NULL, NULL, 'pending', NULL, 1, '2026-04-11 20:57:10');
...
INSERT INTO `rating_review` (`sr_no`, `booking_id`, `room_id`, `user_id`, `rating`, `review`, `admin_reply`, `seen`, `datentime`) VALUES
(4, 21, 5, 2, 5, 'Dịch vụ tuyệt vời, không gian đẳng cấp và được trang bị đầy đủ tiện nghi hiện đại. Rất phù hợp cho những dịp đặc biệt hoặc nghỉ dưỡng cao cấp.', NULL, 1, '2022-08-20 00:22:25'),
(5, 22, 4, 5, 3, 'Chất lượng dịch vụ xuất sắc, phòng rộng rãi, đầy đủ tiện nghi. Không gian sang trọng và thoải mái, rất đáng giá cho kỳ nghỉ.', NULL, 1, '2022-08-20 00:22:30'),
(6, 1, 3, 6, 4, 'Tương tự như “Phòng Cơ bản”, nhưng một số chi tiết như ánh sáng hoặc nội thất cần được cải thiện để mang lại trải nghiệm tốt hơn.', NULL, 1, '2022-08-20 00:22:34'),
(8, 21, 5, 7, 5, 'Nhân viên phục vụ rất chuyên nghiệp, mang lại cảm giác thoải mái và đáng nhớ cho kỳ nghỉ.', NULL, 1, '2022-08-20 00:22:25'),
(9, 22, 3, 8, 4, 'Dịch vụ ổn định, phòng sạch sẽ và gọn gàng. Tuy nhiên, tiện nghi chỉ ở mức cơ bản, phù hợp cho những ai cần chỗ ở ngắn hạn.', NULL, 1, '2022-08-20 00:22:34'),
(10, 1, 6, 2, 5, 'Phòng đẳng cấp, dịch vụ chu đáo, không gian sang trọng. Tuy nhiên, giá thành hơi cao so với những gì nhận được.', NULL, 1, '2022-08-20 00:22:34'),
(12, 1, 3, 7, 5, 'Rất tốt, đỉnh nóc kịch trần, bay phấp pha phấp phới.\r\nHãy gửi voucher discount về cho tôi vì đã để lại bình luận tốt!', NULL, 1, '2024-12-01 11:33:41'),
(13, 23, 3, 12, 5, 'Phòng quá tuyệt vời', 'Cảm ơn b', 1, '2026-04-11 21:00:27');
...
(7, 'Phòng Vip', 50, 12000000, 5, 2, 2, 'Phòng dành cho người giàu có, mang lại phong cách sang chảnh hiếm thấy', 1, 0);
...
(26, 7, 'roomsangtrong.jpg', 1),
(27, 7, 'anh-phong-khach-san-dep-09.jpg', 0);
...
(12, 'Đặng văn tùng dương', 'xaydaa8@gmail.com', 'Gia lộc việt hùng đông anh hà nội', '0345976153', 123, '2004-08-07', 'chill-guy.png', '123456', 0, NULL, NULL, 1, '2026-04-11 19:47:20');
...
INSERT INTO `user_queries` (`sr_no`, `name`, `email`, `subject`, `message`, `admin_reply`, `datentime`, `seen`) VALUES
(13, 'Trung', 'trung@gmail.com', 'Yêu cầu hoàn tiền', 'Cần hỗ trợ hoàn tiền do huỷ đột xuất.', 'Ok b ơi', '2024-12-06 10:10:48', 1);
